...
//
//	mockgen -source=ports/timeout-port/timeout_port.go -destination=mocks/mock_timeout_port.go
//
...
func (m *MockTimeoutProxy) HandleMessage(msg jsonrpcentities.JSONRPCMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockTimeoutProxyFactory) NewTimeoutProxy(timeout time.Duration, autoRestart bool, commandPort commandport.CommandPort) (timeoutport.TimeoutProxy, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewTimeoutProxy", timeout, autoRestart, commandPort)
	ret0, _ := ret[0].(timeoutport.TimeoutProxy)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// NewTimeoutProxy indicates an expected call of NewTimeoutProxy.
func (mr *MockTimeoutProxyFactoryMockRecorder) NewTimeoutProxy(timeout, autoRestart, commandPort any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewTimeoutProxy", reflect.TypeOf((*MockTimeoutProxyFactory)(nil).NewTimeoutProxy), timeout, autoRestart, commandPort)
}
